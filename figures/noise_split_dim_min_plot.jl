...
### Load data
load_dict = load("data/wide_sigma1.jld2")
res = load_dict["res"]
...
## Plot
p = plot(Scale.color_discrete_manual("#E7C15F", "#264653"))
...
draw(PNG("/home/christian/UniMA/EMMA/figures/graphs/wide_sigmas1.png", 20cm, 12cm, dpi=300), p)
